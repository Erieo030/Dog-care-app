...
def today(pet_id:str,user_id:str=Query(alias="userId"),local_date:str|None=Query(default=None,alias="localDate")):return {"success":True,"message":"取得今日紀錄成功","data":daily_log_service.get_today(pet_id,user_id,local_date or datetime.now().astimezone().date().isoformat())}
