...
def build_vet_brief(pet_id: str, user_id: str, days: int) -> VetVisitBrief:
    context_data=build_context(pet_id,user_id,days); result=monitor(context_data); context=AIContext.model_validate(context_data); pet=context.pet
