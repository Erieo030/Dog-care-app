...
export async function searchRecords(
  ...
  const query = new URLSearchParams({
    ...
    healthCategories: filters.healthCategories.join(','),
    clinic: filters.clinic,
    veterinarian: filters.veterinarian,
    attachment: filters.attachment,
    reminderStatus: filters.reminderStatus,
    sort: filters.sort,
    page: String(page),
    pageSize: String(pageSize),
  });
  if (filters.startAt) query.set('startAt', filters.startAt);
